...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2020 at 04:51 PM
...
INSERT INTO `forecasts` (`id`, `userid`, `matchid`, `host_goal`, `guest_goal`) VALUES
(1, 1, 6, 0, 1);
...
CREATE TABLE `matches` (
  ...
  `host_goal` smallint(2) UNSIGNED ZEROFILL DEFAULT NULL,
  `guest_goal` smallint(2) UNSIGNED ZEROFILL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(5, 4, 2, 1, '2020-11-19 23:30:00', 00, 00),
(6, 2, 4, 1, '2020-11-20 23:30:00', 01, 00);
...
CREATE TABLE `scores` (
  ...
  `score` smallint(1) UNSIGNED ZEROFILL NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `scores` (`id`, `userid`, `date`, `score`) VALUES
(1, 1, '2020-11-20 18:48:39', 1);
...
(1, 'چلسی', 'http://localhost/funfoot/public/assets/images/logo/chelsea.png', 225),
(2, 'منچستر', 'http://localhost/funfoot/public/assets/images/logo/manchester_united.png', 225);
...
ALTER TABLE `activations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_activation` (`userid`);
...
ALTER TABLE `forecasts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `forecast_user` (`userid`),
  ADD KEY `forecast_match` (`matchid`);
...
--
ALTER TABLE `activations`
  ADD CONSTRAINT `user_activation` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `forecasts`
--
ALTER TABLE `forecasts`
  ADD CONSTRAINT `forecast_match` FOREIGN KEY (`matchid`) REFERENCES `matches` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `forecast_user` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `matches`
  ADD CONSTRAINT `guest_team` FOREIGN KEY (`guest`) REFERENCES `teams_leagues` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `host_team` FOREIGN KEY (`host`) REFERENCES `teams_leagues` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `premiums`
  ADD CONSTRAINT `user_premium` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `scores`
--
ALTER TABLE `scores`
  ADD CONSTRAINT `user_score` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE CASCADE;
