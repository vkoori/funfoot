...
<title>فان فوت نیوز</title>
<link rel="apple-touch-icon" href="{{ asset('public/assets/images/logo36-negative.png') }}">
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/assets/images/logo36-negative.png') }}">
	...
	{{-- @if (Request::is('admin/new-match'))
		<link rel="stylesheet" href="{{ asset('public/assets/admin/calender/main.css') }}">
		<link rel="stylesheet" href="{{ asset('public/assets/admin/calender/js-persian-cal.css') }}">
	@endif --}}
