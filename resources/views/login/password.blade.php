        ...
        <section class="flex-center">
            <div class="img-rounded border p-1 text-center">
                <form method="post" action="{{ url()->full() }}" accept-charset="utf-8">
                    ...
                    <h1 class="h3">رمز عبور</h1>
                    <p class="mb-1">پسورد حساب کاربری تان را وارد نمایید</p>
                    @if($errors->any())
                    ...
                    <input type="submit" class="img-rounded w-100 mb-1 bt-green" value="ورود">
                    <p><a href="{{ url('فراموشی-رمز').'?'.http_build_query(request()->query())}}" title="فراموشی رمز عبور">رمز عبورم را فراموش کرده ام</a></p>
                </form>
            </div>
        </section>
    </main>
