        ...
        <section class="flex-center">
            <div class="img-rounded border p-1 text-center">
                <form method="post" action="{{ url()->full() }}" accept-charset="utf-8">
                    ...
                    <p class="mb-1">شماره موبایل  خود را وارد کنید</p>
                    <input class="w-100 mb-1" name="mobile" type="text" placeholder="شماره موبایل">
                    @if($errors->any())
                        @foreach($errors->all() as $error)
                        <p class="text-danger">{{ $error }}</p>
                        @endforeach
                    @endif
                    <input type="submit" class="img-rounded w-100 mb-1 bt-green" value="ادامه">
                    <p>استفاده از این سامانه به منزله پذیرفتن <a href="" title="قوانین">قوانین و مقررات</a> میباشد.</p>
                </form>
            </div>
        </section>
    </main>
